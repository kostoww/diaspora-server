...
extern void update_user_guild(char *user_name, char *new_guild, char *new_rank, int new_rank_id);
...
extern void fire_missile(int con, int missile_number);
...
extern struct bot_drop_db bot_drop_item(int b_t, int b_u);
